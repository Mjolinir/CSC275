...
public class Lab_13 extends JFrame implements ActionListener {
	public static LinkedList sl = new LinkedList();
	...
	public Lab_13() {
		...
		menuBar.add(menu);
		menuItem = new JMenuItem("Add Student",new ImageIcon("..\\CSC 275\\src\\Lab_13\\middle.jpg"));
		...
		menu.add(menuItem);
		menuItem = new JMenuItem("Remove Student",new ImageIcon("..\\CSC 275\\src\\Lab_13\\middle.jpg"));
		...
		menu.add(menuItem);
		menu.addSeparator();
		menuItem = new JMenuItem("Display Students",new ImageIcon("..\\CSC 275\\src\\Lab_13\\middle.jpg"));
		...
		menu.add(menuItem);
		menu.addSeparator();
		menuItem = new JMenuItem("Sort Students",new ImageIcon("..\\CSC 275\\src\\Lab_13\\middle.jpg"));
